...
-- #########################################################
-- Black Market Auto-Sell (Gray Items)
-- #########################################################
...
local function SendTransactionInformation(player, item, count, finalPrice, multiplier)
    ...
    if ENABLE_CHAT then
        ...
        DelayedFeedback("|cff20ff20You acquire|r |cffffff00" ..
            FormatMoney(finalPrice) .. "|r.")
    end
...
local function OnGossipHello(event, player, creature)
    ...
    creature:SendUnitWhisper("The Black Market will automatically buy your poor-quality items when enabled!", 0, player)
...
local function OnGossipSelect(event, player, creature, sender, intid)
    ...
    elseif intid == 2 then
        ...
        creature:SendUnitWhisper("You have opted out of the Black Market; traders will ignore your wares.", 0, player)
